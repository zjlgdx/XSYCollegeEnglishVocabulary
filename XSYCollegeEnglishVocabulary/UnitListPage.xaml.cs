...
namespace XSYCollegeEnglishVocabulary
{
    ...
    public sealed partial class UnitListPage : Page
    {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.BookId = bookId;
            var bookUnits = UnitListDataSource.GetUnitList(bookId: bookId);
        ...
        {
            var unitList = (UnitList)e.ClickedItem;
            var unitId = this.BookId + "_" + unitList.UnitID;
            if (!Frame.Navigate(typeof(VocabularyPage), unitId))
            {
